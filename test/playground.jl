...
facility_costs = rand(StableRNG(0), 1:10, I, K);
customer_costs = rand(StableRNG(1), 1:2, I, J, K);
...
gpu_total_cost_coarse(gpu_open_facilities, gpu_problem)
...
@be gpu_total_cost_coarse($gpu_open_facilities, $gpu_problem) seconds = 0.2
